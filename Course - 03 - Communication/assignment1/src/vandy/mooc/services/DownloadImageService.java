...
public class DownloadImageService extends IntentService {
    ...
    public static Intent makeIntent(Context context,
        ...
        intent.putExtra(IMAGE_PATHNAME, directoryPathname);
        return intent;
    }
    ...
    public void onHandleIntent(Intent intent) {
        ...
        // @@ TODO -- you fill in here.
        String pathname = intent.getStringExtra(IMAGE_PATHNAME);

        // Download the requested image.
        // @@ TODO -- you fill in here.
        Uri downloadedImage = Utils.downloadImage(this, imageURL, pathname);
        ...
        // @@ TODO -- you fill in here.
        sendPath(messenger, downloadedImage, imageURL);
    }
    ...
    private Message makeReplyMessage(Uri pathToImageFile,
        ...
        // succeeded or failed.
        // @@ TODO -- you fill in here.
        boolean downloadSucceeded = pathToImageFile != null;
        message.arg1 =  downloadSucceeded? Activity.RESULT_OK : Activity.RESULT_CANCELED;
