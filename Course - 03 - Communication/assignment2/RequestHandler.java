...
class RequestHandler extends Handler {
        ...
        final Runnable downloadImageAndReply =
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        // TODO -- you fill in here.
                        Uri pathToDownloadedImage = Utils.downloadImage(mService.get(), imageUrl, directoryPathname);

                        // Send the path to the image file, url, and
                        // requestCode back to the Activity via the
                        // replyMessenger.
                        // TODO -- you fill in here.
                        sendPath(replyMessenger, pathToDownloadedImage, imageUrl, requestCode);
                    }
                };
    ...
    public void sendPath(Messenger messenger, 
        ...
        // Message.
        // TODO -- you fill in here.
        ReplyMessage replayMessage = ReplyMessage.makeReplyMessage(pathToImageFile,url,requestCode);
        ...
        try {
            ...
            // TODO -- you fill in here.
            messenger.send(replayMessage.getMessage());
        } catch (Exception e) {
