...
public class ImageOpsBoundService extends ImageOpsImpl {
    ...
    public void bindService() {
        if (mRequestMessengerRef == null) {
            ...
            // user.  
            // TODO - you fill in here.
            Intent intent = DownloadImagesBoundService.makeIntent(this.mActivity.get());

            Log.d(TAG, "calling bindService()");

            // Bind to the Service associated with the Intent.
            // TODO -- you fill in here.
            this.mActivity.get().bindService(intent, mServiceConnection, Context.BIND_AUTO_CREATE);
        }
    }
    ...
    public void unbindService() {
        if (mRequestMessengerRef != null) {
            ...
            // TODO -- you fill in here.
            this.mActivity.get().unbindService(this.mServiceConnection);
