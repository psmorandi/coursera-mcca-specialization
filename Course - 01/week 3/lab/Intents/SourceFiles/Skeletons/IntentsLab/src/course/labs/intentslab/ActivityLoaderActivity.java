...
public class ActivityLoaderActivity extends Activity {
	...
	static public final String REQUESTED_TEXT = "lab.coursera_requested_text";
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == Activity.RESULT_OK
			...
			String requestedText = data.getStringExtra(REQUESTED_TEXT);
			mUserTextView.setText(requestedText);
		}
	}
}
