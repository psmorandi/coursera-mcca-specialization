...
public class MainActivity extends LifecycleLoggingActivity {
    ...
    protected void onActivityResult(int requestCode,
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == DOWNLOAD_IMAGE_REQUEST) {
            	...
            	//I didn't want to change the original code, but
            	//files could also be passed as URI.. so why not 
            	// makeGalleryIntent receive an URI? It would make things easier
            	Uri fileUri = data.getData();
            	if(fileUri != null){
	            	String pathToImageFile = fileUri.toString();
        ...
        // code.
        	...
        	Toast.makeText(this,
                    "A problem occurred when trying to download contents from " + getUrl(),
    ...
    protected Uri getUrl() {
        ...
        if (url != null && URLUtil.isValidUrl(uri))
            return url;
        else {
            Toast.makeText(this,
                           "Invalid URL",
